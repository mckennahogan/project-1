...
no.percentile.m5.125<-percentile_basic_bootstrap(nodiab.only.1,5,125)
no.percentile.m5.250<-percentile_basic_bootstrap(nodiab.only.1,5,250)
...
pre.percentile.m5.125<-percentile_basic_bootstrap(prediab.only.1,5,125)
pre.percentile.m5.250<-percentile_basic_bootstrap(prediab.only.1,5,250)
...
no.percentile.m10.125<-percentile_basic_bootstrap(nodiab.only.1,10,125)
no.percentile.m10.250<-percentile_basic_bootstrap(nodiab.only.1,10,250)
...
pre.percentile.m10.125<-percentile_basic_bootstrap(prediab.only.1,10,125)
pre.percentile.m10.250<-percentile_basic_bootstrap(prediab.only.1,10,250)
...
no.percentile.m15.125<-percentile_basic_bootstrap(nodiab.only.1,15,125)
no.percentile.m15.250<-percentile_basic_bootstrap(nodiab.only.1,15,250)
...
pre.percentile.m15.125<-percentile_basic_bootstrap(prediab.only.1,15,125)
pre.percentile.m15.250<-percentile_basic_bootstrap(prediab.only.1,15,250)
...
no.percentile.m30.125<-percentile_basic_bootstrap(nodiab.only.1,30,125)
no.percentile.m30.250<-percentile_basic_bootstrap(nodiab.only.1,30,250)
...
pre.percentile.m30.125<-percentile_basic_bootstrap(prediab.only.1,30,125)
pre.percentile.m30.250<-percentile_basic_bootstrap(prediab.only.1,30,250)
...
no.percentile.m50.125<-percentile_basic_bootstrap(nodiab.only.1,50,125)
no.percentile.m50.250<-percentile_basic_bootstrap(nodiab.only.1,50,250)
...
pre.percentile.m50.125<-percentile_basic_bootstrap(prediab.only.1,50,125)
pre.percentile.m50.250<-percentile_basic_bootstrap(prediab.only.1,50,250)
...
t<-percentile_bootstrap(diab.only.1,30,10)
t
percentile.m30.n10
```
