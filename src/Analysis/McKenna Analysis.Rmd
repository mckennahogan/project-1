...
```{r}
#just bp
  no_pre<- two.boot(HighBP0, HighBP1, "mean", R = 500)

  boot.no_pre<-boot.ci(no_pre,type="perc")
...
```{r}
diff.means.percentile<-function(data0,data1,data2,R){
...
```{r}
diff.means.percentile(HighBP0,HighBP1,HighBP2,1000)
diff.means.percentile(HighChol0,HighChol1,HighChol2,1000)
diff.means.percentile(BMI0,BMI1,BMI2,1000)
diff.means.percentile(AnyHealthcare0,AnyHealthcare1,AnyHealthcare2,1000)
diff.means.percentile(GenHlth0,GenHlth1,GenHlth2,1000)
diff.means.percentile(Income0,Income1,Income2,1000)
```
