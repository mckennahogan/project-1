...
# }
#pull size m, n times
percentile_bootstrap<-function(data,m,n){
  for (b in seq_len(n)){
  ...
  mean.kable<-kable(mean.table,align="c")

  CI.HighBP<-quantile(bootstrap.reps$HighBP,c(.025,.975))
  CI.HighChol<-quantile(bootstrap.reps$HighChol,c(.025,.975))
  CI.BMI<-quantile(bootstrap.reps$BMI,c(.025,.975))
  CI.AnyHealthcare<-quantile(bootstrap.reps$AnyHealthcare,c(.025,.975))
  CI.GenHlth<-quantile(bootstrap.reps$GenHlth,c(.025,.975))
  CI.Income<-quantile(bootstrap.reps$Income,c(.025,.975))
  CI.table<-data.frame(CI.HighBP,CI.HighChol,
                         CI.BMI,CI.AnyHealthcare,CI.GenHlth,CI.Income)
  colnames(CI.table)<-c("High BP","High Chol",
                        "BMI","Any Healthcare","General Health","Income")
  CI.kable<-kable(CI.table,align="c")

  return(list(bootstrap.reps,mean.kable,CI.kable))
}
```

```{r returning percentile bootstrap data}
# m=5 samples
percentile.m5.n10<-percentile_bootstrap(diab.only.1,5,10)
percentile.m5.n25<-percentile_bootstrap(diab.only.1,5,25)
percentile.m5.n75<-percentile_bootstrap(diab.only.1,5,75)
percentile.m5.125<-percentile_bootstrap(diab.only.1,5,125)
percentile.m5.250<-percentile_bootstrap(diab.only.1,5,250)

# m=10 samples
percentile.m10.n10<-percentile_bootstrap(diab.only.1,10,10)
percentile.m10.n25<-percentile_bootstrap(diab.only.1,10,25)
percentile.m10.n75<-percentile_bootstrap(diab.only.1,10,75)
percentile.m10.125<-percentile_bootstrap(diab.only.1,10,125)
percentile.m10.250<-percentile_bootstrap(diab.only.1,10,250)

#m=15 samples
percentile.m15.n10<-percentile_bootstrap(diab.only.1,15,10)
percentile.m15.n25<-percentile_bootstrap(diab.only.1,15,25)
percentile.m15.n75<-percentile_bootstrap(diab.only.1,15,75)
percentile.m15.125<-percentile_bootstrap(diab.only.1,15,125)
percentile.m15.250<-percentile_bootstrap(diab.only.1,15,250)

#m=30 samples
percentile.m30.n10<-percentile_bootstrap(diab.only.1,30,10)
percentile.m30.n25<-percentile_bootstrap(diab.only.1,30,25)
percentile.m30.n75<-percentile_bootstrap(diab.only.1,30,75)
percentile.m30.125<-percentile_bootstrap(diab.only.1,30,125)
percentile.m30.250<-percentile_bootstrap(diab.only.1,30,250)

#m=50 samples
percentile.m50.n10<-percentile_bootstrap(diab.only.1,50,10)
percentile.m50.n25<-percentile_bootstrap(diab.only.1,50,25)
percentile.m50.n75<-percentile_bootstrap(diab.only.1,50,75)
percentile.m50.125<-percentile_bootstrap(diab.only.1,50,125)
percentile.m50.250<-percentile_bootstrap(diab.only.1,50,250)
