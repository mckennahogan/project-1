...
diab_no.row2<-c(HighChol.list[[9]],HighChol.list[[2]][["percent"]][[4]],
        HighChol.list[[6]][["percent"]][[5]],
        HighChol.list[[6]][["basic"]][[4]],HighChol.list[[2]][["basic"]][[5]])
...
# my.table<-data.frame(rbind(HighBP.means,HighChol.means,BMI.means,AnyHealthcare.means,
#                      GenHlth.means,Income.means))
# rownames(my.table)<-c("HighBP","HighChol","BMI","AnyHealthcare","GenHlth","Income")
# colnames(my.table)<-c("no - pre","pre - diab","diab - no")
# my.kable<-kable(my.table)|>
#   kable_paper("hover", full_width = F)
# my.kable
```
